...
const menuVariants = {
    open: {
      ...
      display: 'block', // Garantir que ele seja exibido ao abrir
    },
    closed: {
      height: 0,
      opacity: 0,
      ...
      transitionEnd: {
        display: 'none', // Ocultar após a animação de fechamento
      },
    },
  };
...
export const Navbar =()=> {
    ...
    return(
        ...
        className=" fixed top-0  w-full flex flex-col-reverse md:flex-row  md:justify-around   border-b-[0.5px] border-gray-200 dark:border-gray-800 bg-white dark:bg-[#09090B] z-20">
            ...
            <motion.ul
                className={` md:flex md:items-center mb-1 mt-6 md:mt-2 md:static w-full md:w-auto md:pl-0 pl-9`}
                initial="closed"
