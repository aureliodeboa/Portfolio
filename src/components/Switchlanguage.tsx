...
export const Switchlanguage = ()=>{
    ...
    return(
        <span className="w-20 m-3  flex-row bg-white justify-center rounded-full text-black  text-xs text-center  relative cursor-pointer" onClick={handleToggle}>
          <div className="absolute  bg-white h-full w-full text-black   rounded-2xl   text-xs  border-solid border-2 border-black "><span className="absolute left-0  mx-3 top-1/4">BR</span><span className="absolute right-0 mx-3 top-1/4">US</span></div>
