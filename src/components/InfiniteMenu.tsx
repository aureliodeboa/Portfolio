...
class InfiniteGridMenu {
  ...
  private init(onInit?: InitCallback): void {
    const gl = this.canvas.getContext('webgl2', {
      antialias: true,
      alpha: true, // permite fundo transparente respeitando tema
    ...
    <div ref={containerRef} className="relative w-full h-full bg-transparent">
      ...
      {activeItem && (
        <>
          ...
          absolute
          font-black
          text-2xl sm:text-3xl md:text-5xl lg:text-6xl xl:[font-size:4rem]
          left-1/2 md:left-[1.5em]
          top-[18%] md:top-1/2
          transform
        ...
        `}
          ...
          md:right-[1%]
          transform
          -translate-x-1/2 md:translate-x-[-90%]
          md:-translate-y-1/2
          transition-all
          ease-[cubic-bezier(0.25,0.1,0.25,1.0)]
          ${
